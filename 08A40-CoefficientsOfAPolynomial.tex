...
\usepackage{pmmeta}
\pmcanonicalname{CoefficientsOfAPolynomial}
\pmcreated{2013-03-22 14:01:06}
\pmmodified{2013-03-22 14:01:06}
\pmowner{Wkbj79}{1863}
\pmmodifier{Wkbj79}{1863}
\pmtitle{coefficients of a polynomial}
\pmrecord{9}{34953}
\pmprivacy{1}
...
%\pmkeywords{polynomial coefficients}
...
%% \include{argawarga}
\begin{document}
\PMlinkescapeword{coefficients}

If $\displaystyle p(x)=\sum_{i=0}^n a_i x^i$ is a \PMlinkname{polynomial}{BasicPolynomial}, then its \emph{coefficients} are $\displaystyle \{a_i\}_{i=0}^n$.
%%%%%
%%%%%
\end{document}
